...
return {
  ...
  ["LspDiagnosticsUnderlineWarning"] = { gui = "undercurl", guisp = colors.syntax.color08 },
  ["LspDiagnosticsDefaultInformation"] = { guifg = colors.syntax.color13, gui = "italic" },
  ["LspDiagnosticsSignInformation"] = { guifg = colors.syntax.color13 },
  ["LspDiagnosticsFloatingInformation"] = { guifg = colors.syntax.color13 },
  ["LspDiagnosticsVirtualTextInformation"] = { guifg = colors.syntax.color13, gui = "italic" },
  ["LspDiagnosticsUnderlineInformation"] = { gui = "undercurl", guisp = colors.syntax.color13 },
  ...
  ["LspDiagnosticsUnderlineHint"] = { gui = "undercurl", guisp = colors.syntax.color09 },
  ["LspReferenceText"] = { guifg = colors.syntax.color12, guibg = colors.common.base01, gui = "bold" },
  ["LspReferenceRead"] = { guifg = colors.syntax.color16, guibg = colors.common.base01, gui = "bold" },
  ["LspReferenceWrite"] = { guifg = colors.syntax.color06, guibg = colors.common.base01, gui = "bold" },
