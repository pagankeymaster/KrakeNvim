...
return {
  ...
  ["BufferLineBufferSelected"] = { guifg = colors.common.base09, guibg = colors.common.base00, gui = "bold" },
  ...
  ["BufferLineDuplicateSelected"] = { guifg = colors.common.base09, guibg = colors.common.base00, gui = "bold" },
  ["BufferLineDuplicateVisible"] = { guifg = colors.common.base15, guibg = colors.shades.shade06 },
  ["BufferLineDuplicate"] = { guifg = colors.common.base03, guibg = colors.shades.shade06 },
  ["BufferLinePickSelected"] = { guifg = colors.common.base01, guibg = colors.common.base08, gui = "bold" },
  ["BufferLinePickVisible"] = { guifg = colors.common.base01, guibg = colors.common.base15, gui = "bold" },
