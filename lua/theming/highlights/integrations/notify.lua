...
return {
  ...
  ["NotifyWARNTitle"] = { guifg = colors.common.base01, guibg = colors.common.base13, gui = "bold" },
  ...
  ["NotifyDebugTitle"] = { guifg = colors.common.base01, guibg = colors.common.base15, gui = "bold" },
  ...
  ["NotifyERRORTitle"] = { guibg = colors.common.base01, guifg = colors.common.base11, gui = "bold" },
  ...
  ["NotifyTRACETitle"] = { guifg = colors.common.base01, guibg = colors.common.base10, gui = "bold" },
