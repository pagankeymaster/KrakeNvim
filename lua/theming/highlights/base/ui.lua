...
return {
  ...
  ["NormalFloat"] = { guifg = colors.common.base10, guibg = colors.shades.shade10, blend = 2 },
  ["cheatSeparator"] = { guifg = colors.common.base02 },
  ["FloatBorder"] = { guibg = colors.shades.shade10, guifg = colors.shades.shade10, blend = 2 },
  ...
  ["PmenuSel"] = { guibg = colors.common.base14, guifg = colors.common.base02, gui = "bold", blend = 2 },
