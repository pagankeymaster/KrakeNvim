...
return {
  ["Function"] = { guifg = colors.syntax.color09, gui = "bold" },
  ["Method"] = { guifg = colors.syntax.color01, gui = "bold" },
  ...
  ["SpecialComment"] = { guifg = colors.syntax.color11, gui = "bold" },
  ...
  ["Error"] = { guifg = colors.syntax.color17, gui = "underline," },
