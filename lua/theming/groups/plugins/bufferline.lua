...
return {
  setup = function(colors)
    ...
    hi("BufferLineBackground", { guifg = colors.shades.shade00, guibg = colors.shades.shade06 })
    ...
    hi("BufferLineBufferVisible", { guifg = colors.common.base15, guibg = colors.shades.shade06 })
    hi("BufferLineBufferSelected", { guifg = colors.common.base09, guibg = colors.common.base00, gui = "bold" })
