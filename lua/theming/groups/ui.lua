return {
  setup = function(colors)
    ...
    hi("ErrorMsg", { guifg = colors.common.base11, gui = "undercurl" })
    hi("Folded", { guifg = colors.common.base03 })
    ...
    hi("SpellBad", { guifg = colors.common.base11, gui = "undercurl" })
    hi("SpellCap", { guifg = colors.common.base07, gui = "undercurl" })
    hi("SpellLocal", { guifg = colors.common.base08 })
    hi("SpellRare", { guifg = colors.common.base09 })
    ...
    hi("WarningMsg", { guifg = colors.common.base15, gui = "underline" })
