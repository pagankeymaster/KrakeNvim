return {
  setup = function(colors)
    ...
    hi("Special", { guifg = colors.syntax.color00, gui = "bold" })
    hi("SpecialChar", { guifg = colors.syntax.color09 })
    hi("SpecialComment", { guifg = colors.syntax.color11, gui = "bold" })
    hi("Comment", { guifg = colors.syntax.color14 })
    ...
    hi("Error", { guifg = colors.syntax.color17, gui = "underline," })
