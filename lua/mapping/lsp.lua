...
M.setup = function(client, buffer)
  local mappings = {
    ...
    ["b"] = {
      ...
      ["r"] = { "<CMD>lua require('plugin.config.lsp.handlers.rename').lsp_rename()<CR>", "ﯕ Rename" },
      ["l"] = { "<CMD>lua require('utils.lsp').find_and_run_codelens()<CR>", "Find and run code-lens (up)" },
    },
    ["d"] = {
      ["name"] = " Diagnostics",
    ...
    ["g"] = {
      ...
      ["c"] = { "<CMD>lua vim.lsp.buf.clear_references()<CR>", " Clear References" },
    },
    ["w"] = {
      ["name"] = " Workspaces",
